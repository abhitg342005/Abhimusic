...
API_ID = int(getenv("API_ID","28332123"))
...
OWNER_ID = int(getenv("OWNER_ID", 6708139114))
OWNER = int(getenv("OWNER", 5360305806))
OWNER_USERNAME = getenv("OWNER_USERNAME","Layla_assistant")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/abhitg342005/ivdeonnumilleda.git")
